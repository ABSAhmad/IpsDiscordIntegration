...
class discord_hook_add_new_downloads_file_to_queue extends _HOOK_CLASS_
{
    /**
    ...
    protected function processAfterCreate( $comment, $values )
    {
        ...
        try {
            \IPS\Db::i()->insert('discord_sync_downloads_files', [
                'downloads_file_id' => $this->id,
                'discord_channel_id' => $channelId
            ]);
        } catch (\Throwable $e) {
            \IPS\Log::log($e, 'discord_queue_downloads_file');
        }
    }
