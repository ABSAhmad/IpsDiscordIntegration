...
$lang = array(
    ...
    'discord_post_settings' => "Post Settings",
    ...
    'discord_new_topic' => "New Topic",
    'discord_new_topic_desc' => "This will be posted to a channel when there is a new topic.<br/>%poster = Poster name.<br/>%topicTitle = The title of the topic that is being posted.<br/>%link = Link to the topic.",
    'discord_new_post' => "New Post",
    'discord_new_post_desc' => "This will be posted to a channel when there is a new post.<br/>%poster = Poster name.<br/>%topicTitle = The title of the topic that is being posted in.<br/>%link = Link to the post.",
